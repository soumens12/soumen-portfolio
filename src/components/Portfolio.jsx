...
function Portfolio() {
  // Remove index 3 WITHOUT mutation
  const projects = useMemo(() => {
    return PROJECTS.filter((_, index) => index !== 3);
  }, []);
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="btn-group mb-3">
                ...
                <button
                  onClick={() => handleFilterChange("UI Development")}
                  className={`btn btn-tab ${
                    selectedCategory === "UI Development" ? "active" : ""
                  }`}
                >
                  UI Development
                </button>
                <button
                  onClick={() => handleFilterChange("UI Design")}
                  className={`btn btn-tab ${
                    selectedCategory === "UI Design" ? "active" : ""
                  }`}
                >
                  UI Design
                </button>
                <button
                  onClick={() => handleFilterChange("React UI")}
                  className={`btn btn-tab ${
                    selectedCategory === "React UI" ? "active" : ""
                  }`}
                >
                  React Project
                </button>
                <button
                  onClick={() => handleFilterChange("Graphics Design")}
                  className={`btn btn-tab ${
                    selectedCategory === "Graphics Design" ? "active" : ""
                  }`}
                >
                  Graphics Design
                </button>
